...
function getSteps() {
  return [
    <span className="step-title">
      Copy and past the product's URL and add a product name for your reference
    </span>,
    <span className="step-title">Choose the price to watch</span>,
    <span className="step-title">Configure options</span>
  ];
}
      ...
      case 0:
        return (
          <ProductForm
            ...
            productIsLoading={this.props.productIsLoading}
            productIsNotLoading={this.props.productIsNotLoading}
        ...
        return (
          <div>
            <Options
              ...
              tags={this.props.currentItem.tags}
